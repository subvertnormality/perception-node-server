  ...
  app.get('/game/ui/', function (req, res) {
    ...
    game.currentRound((err, round) => {
      ...
      game.currentGame((err, g) => {
        ...
        let roundComplete = round.round.complete;
        let imageOne = round.round.images[0];
        let imageTwo = round.round.images[1];
        let imageThree = round.round.images[2];
        let score = g.p('score');
        let shame = g.p('shame');
        ...
        res.render('arenablocks', {
          ...
          imageOne: round.round.images[0],
          imageTwo: round.round.images[1],
          imageThree: round.round.images[2],
          level: round.level,
          score: score,
          shame: shame,
          clue: round.round.clue
        });
      })
    });
  });
