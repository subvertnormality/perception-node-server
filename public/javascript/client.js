...
/***/ function(module, exports, __webpack_require__) {
	...
	var hudConsole = __webpack_require__(13);
	var countdown = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var joystickThreshold = 0.3;

	var hammerEvents = [];
	var Podium = {};

	var joystickManager = void 0;
	...
	function addKeyEventsToButton(keyId, keyCode) {
	  ...
	  var mc = new Hammer.Manager(wKey);
	...
	function attachEvents() {
	  ...
	  joystickManager = __webpack_require__(12).create(joystickOptions);

	  joystickManager.on('added', function (evt, nipple) {
	    nipple.on('move', function (evt, data) {
	      var rAngle = data.angle.radian;
